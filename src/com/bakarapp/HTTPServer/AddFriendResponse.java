...
public class AddFriendResponse extends ServerResponseBase{

		
	private static final String TAG = "com.bakarapp.Server.CreateUserResponse";
	public AddFriendResponse(HttpResponse response,String jobjStr,String api) {
	...
	public void process() {
		...
		try {
			...
			ToastTracker.showToast("Friend added");
