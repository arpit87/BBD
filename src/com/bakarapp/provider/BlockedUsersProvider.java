...
public class BlockedUsersProvider extends ContentProvider {
    private static final String TAG = "com.bakarapp.provider.BlockedUsersProvider";
    public final static String AUTHORITY = "com.bakarapp.provider.BlockedUsersProvider";
