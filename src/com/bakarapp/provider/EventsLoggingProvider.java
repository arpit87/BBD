...
public class EventsLoggingProvider extends ContentProvider {
    ...
    private static final String TAG = "com.bakarapp.provider.EventsLoggingProvider";
    public final static String AUTHORITY = "com.bakarapp.provider.EventsLoggingProvider";
