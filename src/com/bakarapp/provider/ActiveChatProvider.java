...
public class ActiveChatProvider extends ContentProvider{
    ...
    private static final String TAG = "com.bakarapp.provider.ActiveChatProvider";
    public final static String AUTHORITY = "com.bakarapp.provider.ActiveChatProvider";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            builder.append("CREATE TABLE activechat (" +
                    ...
                    ",name TEXT" +
                    ",lastMessage TEXT" +
                    ",lastMessageRead INTEGER DEFAULT 1" +
                    ");");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if(oldVersion == 1 && newVersion == 2)
            	db.execSQL("ALTER TABLE activechat ADD COLUMN lastMessageRead INTEGER DEFAULT 1");
            onCreate(db);
        }
    }
