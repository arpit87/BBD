...
public class LikedBeepsProvider extends ContentProvider {
    private static final String TAG = "com.bakarapp.provider.LikedBeepsProvider";
    public final static String AUTHORITY = "com.bakarapp.provider.LikedBeepsProvider";

    private Uri mUri;
    private UriMatcher mUriMatcher;

    private static final int DATABASE_VERSION = 1;
    private static final String mDatabaseName = "likedbeeps.db";
    private static final String mTableName = "likedbeeps";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            builder.append("CREATE TABLE likedbeeps (" +
