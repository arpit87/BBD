...
public class HistoryContentProvider extends ContentProvider {
    private static final String TAG = "com.bakarapp.provider.HistoryContentProvider";

    public final static String AUTHORITY = "com.bakarapp.provider.HistoryContentProvider";
