...
public class FavBeepsProvider extends ContentProvider {
    private static final String TAG = "com.bakarapp.provider.FavBeepsProvider";
    public final static String AUTHORITY = "com.bakarapp.provider.FavBeepsProvider";

    private Uri mUri;
    private UriMatcher mUriMatcher;

    private static final int DATABASE_VERSION = 1;
    private static final String mDatabaseName = "favbeeps.db";
    private static final String mTableName = "favbeeps";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            builder.append("CREATE TABLE favbeeps (" +                    
                    "beepid INTEGER PRIMARY KEY" +
                    ",beepstr TEXT" +                  
                    ",createdby INTEGER" +
                    ",level INTEGER" +
                    ",rebeeps INTEGER" +
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion == 1 && newVersion > 1) {
                db.execSQL("ALTER TABLE chathistory ADD COLUMN imageUrl TEXT;");
            } else {
