...
import com.bakarapp.HTTPServer.CreateAndSendBeepResponse;
...
public class CreateAndSendBeepRequest extends HttpRequest{
	...
	CreateAndSendBeepResponse createBeepResponse;
	String jsonStr;
	HttpResponseListener mListener;
	String mToUser;
	String mFromUser;
	
	public CreateAndSendBeepRequest(String beep_str,int beep_level,String toUser,String fromUser ,HttpResponseListener listener)
	{
		super(URL,RESTAPI);
	...
	public ServerResponseBase execute() {
			...
			createBeepResponse =	new CreateAndSendBeepResponse(response,jsonStr,mToUser,mFromUser,RESTAPI);
