...
import com.bakarapp.beeppopup.ExtendableListView.LayoutParams;
import com.bakarapp.beeppopup.ExtendableListView.ListSavedState;

public class BeepsGridView extends ExtendableListView {

    private static final String TAG = "BeepsGridView";
    ...
    public BeepsGridView(final Context context) {
        this(context, null);
    }

    public BeepsGridView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeepsGridView(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);

        if (attrs != null) {
            // get the number of columns in portrait and landscape
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BeepsGridView, defStyle, 0);

            mColumnCount = typedArray.getInteger(
                    R.styleable.BeepsGridView_column_count, 0);
    ...
    public static class GridLayoutParams extends LayoutParams {
         ...
         */
        private void enforceBeepsLayout() {
    ...
    public static class GridListSavedState extends ListSavedState {
        ...
        @Override
        public String toString() {
            return "BeepsGridView.GridListSavedState{"
                    + Integer.toHexString(System.identityHashCode(this)) + "}";
        }
