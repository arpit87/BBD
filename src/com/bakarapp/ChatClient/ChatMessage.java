...
public class ChatMessage {
	 ...
	 */
	public ChatMessage(final String from, String to, final String message, final boolean isError,final String time, int chatMsgStatus, long unique_id, final String imageUrl) {
		mTo = to;
		mFrom = from;	    
	    mMessage = message;
	    mIsError = isError;
