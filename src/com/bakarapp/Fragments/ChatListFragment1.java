...
import com.bakarapp.Activities.ChatWindowActivity;
...
public class ChatListFragment1 extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent startChatIntent = new Intent(getActivity(),ChatWindowActivity.class);					
		startChatIntent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_SINGLE_TOP
	 			| Intent.FLAG_ACTIVITY_NEW_TASK);			
		startChatIntent.putExtra(ChatWindowActivity.PARTICIPANT, bbdid);			
		startChatIntent.putExtra(ChatWindowActivity.PARTICIPANT_NAME, name);
		getActivity().startActivity(startChatIntent);
