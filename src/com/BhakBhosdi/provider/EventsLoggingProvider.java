package com.BhakBhosdi.provider;
...
public class EventsLoggingProvider extends ContentProvider {

    private static final String TAG = "com.BhakBhosdi.provider.EventsLoggingProvider";
    public final static String AUTHORITY = "com.BhakBhosdi.provider.EventsLoggingProvider";

    private Uri mUri;
    private UriMatcher mUriMatcher;

    private static final int DATABASE_VERSION = 1;
    private static final String mDatabaseName = "events.db";
    private static final String mTableName = "events";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            builder.append("CREATE TABLE events (" +
