...
public class BlockedUsersProvider extends ContentProvider {
    private static final String TAG = "com.BhakBhosdi.provider.BlockedUsersProvider";
    public final static String AUTHORITY = "com.BhakBhosdi.provider.BlockedUsersProvider";
