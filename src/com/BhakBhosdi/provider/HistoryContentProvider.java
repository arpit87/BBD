...
public class HistoryContentProvider extends ContentProvider {
    private static final String TAG = "com.BhakBhosdi.provider.HistoryContentProvider";

    public final static String AUTHORITY = "com.BhakBhosdi.provider.HistoryContentProvider";
