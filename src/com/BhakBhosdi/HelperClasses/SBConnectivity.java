...
public class SBConnectivity {
    ...
    private static String TAG = "com.BhakBhosdi.HelperClasses.SBConnectivity";
    ...
    public static boolean isConnected() {
        try {
            ...
            //Log.d("com.BhakBhosdi.HelperClasses.SBConnectivity", "No response");
            if (Platform.getInstance().isLoggingEnabled()) Log.d(TAG, "no data available by http timeout");
            return false;
        } catch (Exception e) {
            //Log.e("com.BhakBhosdi.HelperClasses.SBConnectivity", e.getMessage());
            return false;
        }
