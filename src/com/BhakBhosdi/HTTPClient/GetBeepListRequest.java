package com.BhakBhosdi.HTTPClient;
...
import com.BhakBhosdi.HTTPServer.GetBeepListResponse;
import com.BhakBhosdi.HTTPServer.ServerConstants;
import com.BhakBhosdi.HTTPServer.ServerResponseBase;
import com.BhakBhosdi.Users.UserAttributes;
import com.BhakBhosdi.Util.BBDTracker;
import com.BhakBhosdi.Util.Logger;

public class GetBeepListRequest extends HttpRequest{

	private String TAG = "com.BhakBhosdi.HttpClient.getBeepListRequest";
    private static String RESTAPI="getBeepList";
	...
	GetBeepListResponse getBeepResponse;
	String jsonStr;
	HttpResponseListener mListener;
	public GetBeepListRequest(int beeplevel, int numbeeps, HttpResponseListener listener)
	{		
		super(URL,RESTAPI);
		...
		params.add( new BasicNameValuePair( UserAttributes.BEEP_LEVEL, Integer.toString(beeplevel) ) );
	...
	public ServerResponseBase execute() {
		BBDTracker.sendEvent("HttpRequest",RESTAPI,"httprequest:"+RESTAPI+":execute",1L);
			...
			getBeepResponse =	new GetBeepListResponse(response,jsonStr,RESTAPI);
